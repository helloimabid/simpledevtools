    ...
    <nav class="fixed top-0 w-full z-50 glass-nav transition-colors duration-300 border-b border-neutral-200/50 dark:border-neutral-800/50 backdrop-blur-md bg-white/70 dark:bg-black/70">
        <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            <a href="/" class="flex items-center gap-2 group">
                <img src="logo.png" alt="SimpleDevTools Logo" class="w-8 h-8 group-hover:scale-105 transition-transform" loading="lazy" decoding="async" width="32" height="32">
            ...
            <div class="grid grid-cols-1 md:grid-cols-6 gap-8 mb-12">
                <div class="col-span-1 md:col-span-2">
                    <div class="flex items-center gap-2 mb-4">
                       <img src="logo.png" alt="SimpleDevTools" class="w-8 h-8" loading="lazy" decoding="async" width="32" height="32">
            ...
            <div class="flex flex-col h-full">
                ...
                <div class="flex items-center justify-between p-6 border-b border-neutral-200 dark:border-neutral-800">
                    <div class="flex items-center gap-2">
                        <img src="logo.png" alt="SimpleDevTools Logo" class="w-6 h-6" loading="lazy" decoding="async" width="24" height="24">
